...
class Hospital:
    def __init__(self):
        print(
            '_____________________________________________________________________WELOCOME TO RAINBOW Hospital______________________________________________________________________')
        print()
        self.all = [{}]
        self.menu()
